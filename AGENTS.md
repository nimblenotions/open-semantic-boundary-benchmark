...
- Do not autonomously rewrite reader-facing prose for style. Preserve established terminology and scientific claims unless an explicit editorial change is requested.
...
**Do not use in reader-facing prose** (development jargon): downstream *team*; unofficial “Open-SBB score”; “bite”; “dumb redactor”; “hero question”; “Track C” (keep that identifier in protocol/release files where it names a scoring path); forthcoming technical report; EasyChair/Sheridan paper id **4405**.
...
Keep camera-ready preparation history, Sheridan identifiers, and other release archaeology out of reader-facing documentation.
